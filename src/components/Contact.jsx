    ...
    <div name="contact" className="w-full bg-mySignatureColor text-white pt-16 pb-8">
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center mt-8 md:hidden">
          <a href="https://www.linkedin.com/in/kvkvarma" target="_blank" rel="noopener noreferrer" className="text-white sm:hover:text-yellow-500 mx-4">
            <FaLinkedin size={30} />
          </a>
          <a href="https://github.com/kvkvarma" target="_blank" rel="noopener noreferrer" className="text-white sm:hover:text-yellow-500 mx-4">
            <FaGithub size={30} />
          </a>
          <a href="mailto:vijayvarmakucharlapati@gmail.com" target="_blank" rel="noopener noreferrer" className="text-white sm:hover:text-yellow-500 mx-4">
